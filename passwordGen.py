...
passwordGen.py
Author: Ritchie Deel
This is a password generator. This program prompts user for a password length as well as if they
want uppercase, lowercase, numbers, and or punctuation in their password.
"""
...
# Check "Y" or "y" from a tuple. If user enters "y" or "Y" for use_uppercase letters, append upper to charset.
if use_upper in ('Y', 'y'):
    charset += upper

# Check "Y" or "y" from a tuple. If user enters "y" or "Y" for use_lowercase letters, append lower to charset
if use_lower in ('Y', 'y'):
    charset += lower

# Check "Y" or "y" from a tuple. If user enters "y" or "Y" for use_numbers, append numbers to charset
if use_numbers in ('Y', 'y'):
    charset += numbers

# Check "Y" or "y" from a tuple. If user enters "y" or "Y" for use_punctuation, append punctuation to charset
